	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 portfolio-item">
				<a href="categoryStore.do" class="portfolio-link">
					<div class="caption">
			...
			<div class="col-sm-3 portfolio-item">
				<a href="categoryStore.do?s_category=한식" class="portfolio-link">
					<div class="caption">
						<div class="caption-content">
							<h3>Korean</h3>
							<h4>한식</h4>
			...
			<div class="col-sm-3 portfolio-item">
				<a href="categoryStore.do?s_category=일식" class="portfolio-link">
					<div class="caption">
						<div class="caption-content">
							<h3>Japaness</h3>
							<h4>일식</h4>
			...
			<div class="col-sm-3 portfolio-item">
				<a href="categoryStore.do?s_category=중식" class="portfolio-link">
					<div class="caption">
						<div class="caption-content">
							<h3>Chiness</h3>
							<h4>중식</h4>
			...
			<div class="col-sm-4 portfolio-item">
				<a href="categoryStore.do?s_category=양식" class="portfolio-link">
					<div class="caption">
						<div class="caption-content">
							<h3>Western</h3>
							<h4>양식</h4>
			...
			<div class="col-sm-4 portfolio-item">
				<a href="categoryStore.do?s_category=아시아식" class="portfolio-link">
					<div class="caption">
						<div class="caption-content">
							<h3>Asian</h3>
							<h4>아시아식</h4>
			...
			<div class="col-sm-4 portfolio-item">
				<a href="categoryStore.do?s_category=술집" class="portfolio-link">
					<div class="caption">
						<div class="caption-content">
							<h3>Pub & Beer</h3>
							<h4>술집</h4>
