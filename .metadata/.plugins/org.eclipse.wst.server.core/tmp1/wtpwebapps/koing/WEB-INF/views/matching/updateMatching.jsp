			...
			<table class="table table-bordered">
				<tr>
					...
					<td><input type="text" id="mc_title" name="mc_title"
						value="${matching.mc_title}"></td>
				</tr>

				<tr>
					<th>매칭 소개글</th>
					<td><textarea rows="3" cols="40" id="mc_contents"
							name="mc_contents">${matching.mc_contents}</textarea></td>
				</tr>

				<tr>
					<th>장소</th>
					<td><input type="text" id="s_name" name="s_name"
						value="${matching.s_name}"></td>
				</tr>

				<tr>
					<th>참가비</th>
					<td><input type="text" id="mc_entryfee" name="mc_entryfee" value="${matching.mc_entryfee}">
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" id="mc_date" name="mc_date"
						value="${matching.mc_date}"></td>
				</tr>

				<tr>
					<th>모임 시간</th>
					<td><input type="text" id="mc_time" name="mc_time"
						value="${matching.mc_time}"></td>
				</tr>
